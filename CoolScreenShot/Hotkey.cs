...
namespace MovablePython
{
    ...
    //Got from: http://www.mobzystems.com/tools/seethroughwindows/
    public class Hotkey2 : IMessageFilter
    {
        ...
        public Hotkey2(Keys keyCode, bool shift, bool control, bool alt, bool windows)
            : this()
        {
            // Assign properties
            this.KeyCode = keyCode;
        ...
        /// </summary>
        /// <returns></returns>
        public Hotkey2 Clone()
        {
            // Clone the whole object
            return new Hotkey2(this.keyCode, this.shift, this.control, this.alt, this.windows);
        }
        ...
        {
            // Only process WM_HOTKEY messages
            if (message.Msg != Hotkey2.WM_HOTKEY)
            {
                return false;
            }
