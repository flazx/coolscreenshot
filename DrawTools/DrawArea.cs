...
namespace DrawTools
{
    public partial class DrawArea : UserControl
    {
        ...
        public void Initialize(IDrawAreaOwner owner, DocManager docManager)
        {
        ...
        private void OnContextMenu(MouseEventArgs e)
        {
            ...
            m_ContextMenu.Show(owner.getForm(), point);
        ...
        public Image OriginalBackgroundImage { 
        	get{return originalBackgroundImage;} 
        	set
        	{
        		originalBackgroundImage = value;
        	}
        }
        #endregion
